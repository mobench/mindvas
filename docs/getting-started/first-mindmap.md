---
description: Create your first mind map on Obsidian Canvas.
---
...
{% hint style="info" %}
Assign a hotkey to "Add child node" in **Settings > Hotkeys** for faster workflow. We recommend `Ctrl+.`
{% endhint %}
{% endstep %}
...
* [All commands](../reference/commands.md) — full list of available commands
* [Mouse actions](../reference/mouse-actions.md) — everything you can do with clicks and drags
* [Map outline](../features/map-outline.md) — the sidebar panel in depth
